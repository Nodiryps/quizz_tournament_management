...
public class ViewGame extends VBox {
    ...
    private void configBindSelectRadioBtn() {
        reponse1.setSelected(boolUnselectRadioBtn.get());
        reponse2.setSelected(boolUnselectRadioBtn.get());
        reponse3.setSelected(boolUnselectRadioBtn.get());
        reponse4.setSelected(boolUnselectRadioBtn.get());
    }
